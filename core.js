...
export function setFirstGenTag(skillId){
  ...
  if(!state.choices.tags.includes(skillId)){
    state.choices.tags.push(skillId);
  }
}

export function getFirstGenTag(){
  return state.choices?.firstGenTag || null;
}
